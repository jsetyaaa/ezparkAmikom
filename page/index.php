...
<body class="bg-main-color flex flex-col items-center justify-center w-screen">
    <div class="container">
        ...
        <div>
            ...
            <div class="text-center">
                <button type="submit" class="mt-16 bg-button-color w-80 h-12 rounded-full text-white font-semibold tracking-widest text-lg">L
                    o
                    g i n</button>
            </div>
            </form>
        ...
        <div class="bottom-0 w-full text-center mt-16 mb-4">
            <h2 class="text-lg text-font-color font-bold tracking-widest"><a href="../page/daftar.php">D a f t a r</a>
            </h2>
        </div>
    </div>
</body>
